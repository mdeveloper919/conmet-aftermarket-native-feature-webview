...
export const STEP_NAVIGATION = [
	{ id: 0, path: 'hubs'}, //0
	{ id: 15, path: 'hubs'}, //1
	{ id: 2, path: 'truckType'}, //2
	{ id: 5, path: 'truckMake'}, //3
	{ id: 7, path: 'axle'}, //4
	{ id: 14, path: 'mountingSystem'}, //5
	{ id: 8, path: 'gawr'}, //6
	{ id: 12, path: 'stud'}, //7
	{ id: 9, path: 'wheelType'}, //8
	{ id: 10, path: 'material'}, //9
	{ id: 11, path: 'hubType'}, //10
	{ id: 12, path: 'finderResults'} //11
]
...
export const APPSTATE = {
	...
	filterResults: [
		[],
		[],
		[], //truckCompartmentIds - 2
		[], //truckMakeIds - 3
		[], //axleNameIds -4
		[], //grossAxleWeightRatingRangeIds - 5
		[], //mounting - 6
		[], //axleStudThreadIds - 7
		[], //wheelMaterialStudLengthClassIds - 8
		[], //hubCastingMaterialTypeIds - 9
		[] //hubAssemblyTypeIds - 10
